...
const API_URL_POST_REGISTER_MENU   = `${API_BASE_URL}/menu/register`;    // 사이트맥 등록
...
const registerMenu = (params, onError) =>
  NetworkUtil.postData(API_URL_POST_REGISTER_MENU, params, onError);
